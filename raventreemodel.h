...
class RavenTreeModel : public QAbstractItemModel {
  ...
  public:
    ...
    static RavenTreeItem *createNode(const QString &name, const QString &fullPath, const QString &absPath,
                                     git_status_t flag, bool binary, bool heading, bool deleted,
                                     std::optional<QStringConverter::Encoding> encodingOpt);
    static RavenTreeItem *findParentNodeByAbsPathAndInitiator(RavenTreeItem *root, RavenTreeItem *child);

    static RavenTreeItem *findNodeByRelPathAndInitiator(RavenTreeItem *root, const QString &relativePath,
                                                        RavenTreeItem::RavenTreeCategory initiator);

    static RavenTreeItem *findNodeByAbsPathAndInitiator(RavenTreeItem *root, const QString &absolutePath,
                                                        RavenTreeItem::RavenTreeCategory initiator);
